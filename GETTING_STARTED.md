...
All server configuration lives in `openclaw.json` under `plugins.entries.openclaw-mcp-bridge.config.servers`. Each key is a server name you choose, and the value describes how to connect.
